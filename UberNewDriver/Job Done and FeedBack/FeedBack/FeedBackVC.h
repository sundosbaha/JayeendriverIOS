...
@property NSString *InstantjobStatus;
@property NSString *DOGRATE;
...
//////////// Outlets Price Label
@property (weak, nonatomic) IBOutlet UILabel *LblAdminCommission;
@property (weak, nonatomic) IBOutlet UILabel *LblAdminCommissionValue;
@property (weak, nonatomic) IBOutlet UILabel *LblDriverCommission;
@property (weak, nonatomic) IBOutlet UILabel *LblDriverCommissionvalue;
...
@property (weak, nonatomic) IBOutlet UILabel *lblCostPrice;
